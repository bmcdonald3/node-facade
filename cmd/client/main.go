...
Examples:
  # Create from stdin
  echo '{"xname": "example-name", "powerState": "example-value"}' | client node create

  # Create with --spec flag
  client node create --spec '{"xname": "example-name", "powerState": "example-value"}'

Spec fields:
  xname (string) [required]
  powerState (string) [required]
`,
	RunE: func(cmd *cobra.Command, args []string) error {
		c, err := getClient()
		if err != nil {
...
Examples:
  # Update from stdin
  echo '{"xname": "example-name", "powerState": "example-value"}' | client node update <uid>

  # Update with --spec flag
  client node update <uid> --spec '{"xname": "example-name", "powerState": "example-value"}'
