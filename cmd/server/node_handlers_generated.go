...
// Generated: 2025-11-21T14:26:53-08:00
//
...
func CreateNode(w http.ResponseWriter, r *http.Request) {
	...
	if err := events.PublishResourceCreated(r.Context(), "Node", node.GetUID(), node.GetName(), node); err != nil {
...
func UpdateNode(w http.ResponseWriter, r *http.Request) {
	...
	if err := events.PublishResourceUpdated(r.Context(), "Node", node.GetUID(), node.GetName(), node, updateMetadata); err != nil {
		// Log the error but don't fail the request - events are non-critical
...
func PatchNode(w http.ResponseWriter, r *http.Request) {
	...
	if err := events.PublishResourcePatched(r.Context(), "Node", node.GetUID(), node.GetName(), node, patchMetadata); err != nil {
		// Log the error but don't fail the request - events are non-critical
...
func UpdateNodeStatus(w http.ResponseWriter, r *http.Request) {
	...
	var statusUpdate node.NodeStatus
	...
	if err := events.PublishResourceUpdated(r.Context(), "Node", res.GetUID(), res.GetName(), res, statusMetadata); err != nil {
...
func PatchNodeStatus(w http.ResponseWriter, r *http.Request) {
	...
	if err := events.PublishResourcePatched(r.Context(), "Node", res.GetUID(), res.GetName(), res, patchMetadata); err != nil {
...
func DeleteNode(w http.ResponseWriter, r *http.Request) {
	...
	if err := events.PublishResourceDeleted(r.Context(), "Node", node.GetUID(), node.GetName(), deleteMetadata); err != nil {
		// Log the error but don't fail the request - events are non-critical
